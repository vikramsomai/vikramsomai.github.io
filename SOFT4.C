...
gotoxy(15,2);cprintf("databse");
gotoxy(4,4);cprintf("name");
gotoxy(15,4);cprintf("address");
gotoxy(30,4);cprintf("ph.no");
gotoxy(45,4);cprintf("city\n");
gotoxy(55,4);cprintf("gender\n");
for(i=0;i<80;i++)
{gotoxy(i,5);
cprintf("%c",196);
}
...
gotoxy(15,6+i);cprintf("%s",s[i].add);
gotoxy(30,6+i);cprintf("%ld",s[i].num);
gotoxy(45,6+i);cprintf("%s",s[i].city);
gotoxy(55,6+i);cprintf("%s",s[i].gender);
}
}
fclose(fpt);
}
